...
angular.module('borrow.dashboard', [])
  .controller('dashController', function($rootScope, $scope, $http, $location, Auth, filepickerService, Item, Message) {
  ...
  Message.totalMessages(function(num) {
    $scope.numMessages = num;
  });
